...
class Pokemon:
    ...
    def _init_(self, nombre, tipo, nivel, voltaje_max, amperaje_max, color):
        self.nombre = nombre
        self.tipo = tipo
        self.nivel = nivel
    ...
    def correr(self):
        print(f"{self.nombre} correr!!")


class Acuatico(Pokemon):
    def _init_(self, nombre, tipo, nivel, voltaje_max, amperaje_max, color, acuatico):
        super()._init_(nombre, tipo, nivel, voltaje_max, amperaje_max, color)
...
pikachu = Pokemon("pika", "electrico", 10, 100, 100, "amarillo")
